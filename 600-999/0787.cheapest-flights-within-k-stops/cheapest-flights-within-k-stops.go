...
//	For SSSP(single source shortest path) problem,
//	we use Dijkstra or BellmanFord to solve.
//	This problem need to find the SSSP via k vertices,
//	that is BellmanFord for.
